...
namespace UnityEngine.Rendering.HighDefinition
{
    public partial class HDRenderPipeline
    {
            ...
            TextureHandle rayCountTexture, TextureHandle screenSpaceShadowArray)
        {
            ...
            bool screenSpaceShadowRequired = m_CurrentSunLightAdditionalLightData != null && (m_CurrentSunShadowMapFlags & HDVisibleLightEntities.ShadowMapFlags.WillRenderScreenSpaceShadow) != 0;

            // Render directional screen space shadow if required
            if (screenSpaceShadowRequired)
            {
                bool rayTracedDirectionalRequired = (m_CurrentSunShadowMapFlags & HDVisibleLightEntities.ShadowMapFlags.WillRenderRayTracedShadow) != 0;

...
namespace UnityEngine.Rendering.HighDefinition
{
    internal partial class HDVisibleLightEntities
    {
        ...
        struct ProcessVisibleLightJob : IJobParallelFor
        {
            ...
            public NativeArray<int> visibleLightProcessedIndices;
            [WriteOnly]
            [NativeDisableContainerSafetyRestriction]
            public NativeArray<int> processedLightVisibleIndices;
            [WriteOnly]
            [NativeDisableContainerSafetyRestriction]
            ...
            public void Execute(int index)
            {
                ...
                visibleLightProcessedIndices[index] = outputIndex;
                processedLightVisibleIndices[outputIndex] = index;
            ...
            DebugDisplaySettings debugDisplaySettings)
        {
            ...
            var processVisibleLightJob = new ProcessVisibleLightJob()
            {
                ...
                visibleLightProcessedIndices   = m_VisibleLightProcessedIndices,

                //Output processed lights.
                processedVisibleLightCountsPtr = m_ProcessVisibleLightCounts,
                processedLightVisibleIndices   = m_ProcessedLightVisibleIndices,
